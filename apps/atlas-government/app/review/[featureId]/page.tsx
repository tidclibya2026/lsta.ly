...
export default function ReviewFeaturePage() {
  ...
  const images = <div className="reviewImages">{feature.images.length ? feature.images.map((src) => <img key={src} src={src} alt={feature.name_ar || "صورة السجل"} />) : <p>لا توجد صور.</p>}</div>;
